...
#       movies
#     JOIN
#       castings julie_castings ON julie_castings.movie_id = movie.id
#     JOIN
#       actors julie_actors ON julie_actors.castings.actor_id = actors.id
#     JOIN
...
def colleagues_of_garfunkel
  ...
  execute(<<-SQL)
    ...
    JOIN (
        ...
        WHERE
          actors.name != 'Art Garfunkel'
      ) as other_actors ON art_movies.id = other_actors.movie_id;
  SQL
end
